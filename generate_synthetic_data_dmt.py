...
import utils as ut
# data from Zafar et. al 2017 

def generate_synthetic_data_dmt(data_type, plot_data=False):
    ...
    n_samples = 4000 # generate these many data points per cluster
    ...
    if data_type == 1:
        ...
        """
        Generate data such that a classifier optimizing for accuracy will have disparate false negative rates for both groups but will have equal false positive rates.
        """
